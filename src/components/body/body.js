        ...
        <>
            <main id='body_main'>
                <div id='body__main_parent'>
                    ...
                    <Link to="jamin/546456456  " className="ul-link"><div className='body__main_child'>
                    ...
                    <Link to="jamin/5676" className="ul-link"><div className='body__main_child'>
                        <div className='card__main_parent'>
                            <img src={Jaminrasid} className='image_src'></img>
                            <p>जन्म प्रमाण पत्र </p>
                        </div>
                    </div></Link>
                    <Link to="jamin/56746" className="ul-link"><div className='body__main_child'>
                        <div className='card__main_parent'>
                            <img src={Jaminrasid} className='image_src'></img>
                            <p>आय प्रमाण पत्र</p>
                        </div>
                    </div></Link>
                    <Link to="jamin/76786" className="ul-link"><div className='body__main_child'>
                        <div className='card__main_parent'>
                            <img src={Jaminrasid} className='image_src'></img>
